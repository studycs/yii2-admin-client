  ...
  >
    ...
    >
      <a-form-item label="角色标识" name="roleCode">
        <a-input allow-clear :maxlength="20" placeholder="请输入角色标识" v-model:value="form.roleCode"/>
      </a-form-item>
      <a-form-item label="角色名称" name="roleName">
        <a-input allow-clear :maxlength="20" placeholder="请输入角色名称" v-model:value="form.roleName"/>
      </a-form-item>
    </a-form>
  </ele-modal>
</template>
