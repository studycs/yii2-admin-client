    ...
    <a-form ref="formRef" :model="form" :rules="rules" :label-col="{ md: 6, sm: 4, xs: 24 }" :wrapper-col="{ md: 18, sm: 20, xs: 24 }">
      <a-row :gutter="16">
        <a-col :md="12" :sm="24" :xs="24">
          ...
          <a-form-item label="辅助邮箱" name="aux_mail">
            <a-input allow-clear :maxlength="20" placeholder="辅助邮箱" v-model:value="form.aux_mail" />
          </a-form-item>
        ...
        <a-col :md="12" :sm="24" :xs="24">
          ...
          <a-form-item v-if="props.isAdmin" label="所属分组" name="group_id">
            <gv-group placeholder="所属分组" v-model:value="form.group_id" />
          </a-form-item>
        </a-col>
      </a-row>
    </a-form>
...
import {UpdateGvAccount} from '@/api/admin/gv'
import useFormData from "@/utils/use-form-data";
import GvGroup from "@/views/gv/accout/gv-group.vue";
