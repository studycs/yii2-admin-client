<template>
  <div class="ele-body">
    ...
    <message-create v-model:visible="showEdit" :data="current" @done="reload" />
  </div>
</template>
<script setup>
...
import {GetMessageList,DelMessageItem} from '@/api/admin/message'
import {PlusOutlined, DeleteOutlined} from '@ant-design/icons-vue';
import MessageCreate from "@/views/message/list/message-create.vue";
const { query } = unref(currentRoute);
const ROUTE_PATH = '/message/list';
const groupId = ref(0);
// 是否显示编辑弹窗
