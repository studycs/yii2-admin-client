      ...
      <a-row :gutter="16">
        <a-col :md="24" :sm="24" :xs="24">
          ...
          <a-form-item label="选择发送组" name="gv_group_id">
            <send-group placeholder="选择发送组" v-model:value="form.gv_group_id" />
          </a-form-item>
...
import {sendMessage} from '@/api/admin/template'
import SendGroup from "@/views/template/group/send-group.vue";
import ReceiveSend from "@/views/template/group/receive-send.vue";
import MessageGroup from "@/views/template/group/message-group.vue";
